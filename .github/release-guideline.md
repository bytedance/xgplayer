...
GitHub Release notes are generated by CI. The comparison base is always the latest previous stable tag (`vX.Y.Z`) before the current version, even for prerelease tags. For example, `v3.2.1-rc.1` compares against `v3.2.0`, not another prerelease tag.
