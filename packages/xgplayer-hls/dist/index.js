(function (global, factory) {
  ...
  var PageVisibility = function () {
    function PageVisibility() {
      _classCallCheck$9(this, PageVisibility);
  ...
  var MediaSegmentList = function () {
    function MediaSegmentList(type) {
      _classCallCheck$a(this, MediaSegmentList);
    ...
    _createClass$a(MediaSegmentList, [{
      key: "isEmpty",
  ...
  var AudioTrackMeta = function () {
    function AudioTrackMeta(meta) {
      _classCallCheck$m(this, AudioTrackMeta);
  ...
  var VideoTrackMeta = function () {
    function VideoTrackMeta(meta) {
      _classCallCheck$m(this, VideoTrackMeta);
  ...
  var AudioTrackSample = function () {
    function AudioTrackSample(info) {
      _classCallCheck$n(this, AudioTrackSample);
    ...
    _createClass$n(AudioTrackSample, null, [{
      key: "getDefault",
  ...
  var VideoTrackSample = function () {
    function VideoTrackSample(info) {
      _classCallCheck$n(this, VideoTrackSample);
    ...
    _createClass$n(VideoTrackSample, null, [{
      key: "getDefault",
      value: function getDefault() {
        return {
          dts: null,
  ...
  var HlsLiveController = function () {
    function HlsLiveController(configs) {
      _classCallCheck$q(this, HlsLiveController);
    ...
    _createClass$q(HlsLiveController, [{
      key: 'init',
      value: function init() {
  ...
  var HlsLivePlayer = function (_Player) {
    ...
    function HlsLivePlayer(options) {
      _classCallCheck$r(this, HlsLivePlayer);
  ...
  var MediaInfo$1 = function () {
    function MediaInfo() {
      _classCallCheck$s(this, MediaInfo);
  ...
  var Context$1 = function () {
    function Context() {
      ...
      _classCallCheck$t(this, Context);
    ...
    _createClass$t(Context, [{
      ...
      value: function registry(tag, cls) {
        ...
        var enhanced = function (_cls) {
          ...
          function enhanced(a, b, c) {
            _classCallCheck$t(this, enhanced);
  ...
  var MediaSample = function () {
    function MediaSample(info) {
      ...
      _classCallCheck$u(this, MediaSample);
    ...
    _createClass$u(MediaSample, null, [{
      key: 'getDefaultInf',
  ...
  var MediaSegment = function () {
      function MediaSegment() {
          _classCallCheck$v(this, MediaSegment);
  ...
  var MediaSegmentList$1 = function () {
    function MediaSegmentList(type) {
      _classCallCheck$w(this, MediaSegmentList);
    ...
    _createClass$w(MediaSegmentList, [{
      key: "isEmpty",
      value: function isEmpty() {
        return this._list.length === 0;
      }
  ...
  var HlsVodController = function () {
    function HlsVodController(configs) {
      _classCallCheck$x(this, HlsVodController);
    ...
    _createClass$x(HlsVodController, [{
      key: 'init',
      value: function init() {
        // 初始化Buffer （M3U8/TS/Playlist);
        this._context.registry('M3U8_BUFFER', XgBuffer);
  ...
  var HlsVodPlayer = function (_Player) {
    ...
    function HlsVodPlayer(options) {
      _classCallCheck$y(this, HlsVodPlayer);
  ...
  var HlsPlayer = function HlsPlayer(config) {
    _classCallCheck$z(this, HlsPlayer);
