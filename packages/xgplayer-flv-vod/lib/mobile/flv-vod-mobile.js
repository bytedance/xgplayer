...
var LiveMobileController = function (_LiveController) {
  _inherits(LiveMobileController, _LiveController);

  function LiveMobileController() {
    _classCallCheck(this, LiveMobileController);

    return _possibleConstructorReturn(this, (LiveMobileController.__proto__ || Object.getPrototypeOf(LiveMobileController)).apply(this, arguments));
  }

  _createClass(LiveMobileController, [{
...
exports.default = LiveMobileController;