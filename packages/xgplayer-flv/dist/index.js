(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('xgplayer'), require('xgplayer-transmuxer-codec-avc'), require('xgplayer-transmuxer-codec-hevc')) :
  typeof define === 'function' && define.amd ? define(['xgplayer', 'xgplayer-transmuxer-codec-avc', 'xgplayer-transmuxer-codec-hevc'], factory) :
  (global = global || self, global.FlvPlayer = factory(global.Player, global.xgplayerTransmuxerCodecAvc, global.xgplayerTransmuxerCodecHevc));
}(this, (function (Player, xgplayerTransmuxerCodecAvc, xgplayerTransmuxerCodecHevc) { 'use strict';
  ...
  var ALLEVENTS$1 = Object.assign({}, LOADER_EVENTS$3, DEMUX_EVENTS$3, REMUX_EVENTS$4, MSE_EVENTS$2, HLS_EVENTS$1, PLAYER_EVENTS$2, BROWSER_EVENTS$2);

  var FlvAllowedEvents$1 = [];
  var HlsAllowedEvents$1 = [];

  for (var key$1 in ALLEVENTS$1) {
    if (ALLEVENTS$1.hasOwnProperty(key$1)) {
      FlvAllowedEvents$1.push(ALLEVENTS$1[key$1]);
    }
  }

  for (var _key$1 in ALLEVENTS$1) {
    if (ALLEVENTS$1.hasOwnProperty(_key$1)) {
      HlsAllowedEvents$1.push(ALLEVENTS$1[_key$1]);
    }
  }

  var EVENTS$1 = {
    ALLEVENTS: ALLEVENTS$1,
    HLS_EVENTS: HLS_EVENTS$1,
    REMUX_EVENTS: REMUX_EVENTS$4,
    DEMUX_EVENTS: DEMUX_EVENTS$3,
    MSE_EVENTS: MSE_EVENTS$2,
    LOADER_EVENTS: LOADER_EVENTS$3,
    FlvAllowedEvents: FlvAllowedEvents$1,
    HlsAllowedEvents: HlsAllowedEvents$1,
    CRYTO_EVENTS: CRYTO_EVENTS$1,
    PLAYER_EVENTS: PLAYER_EVENTS$2,
    BROWSER_EVENTS: BROWSER_EVENTS$2
  };
  ...
  var isObjectFilled$2 = function isObjectFilled(obj) {
    for (var key in obj) {
      if (obj.hasOwnProperty(key)) {
        if (obj[key] === null) {
          return false;
  ...
  var MediaInfo$2 = function () {
    function MediaInfo() {
      _classCallCheck$A(this, MediaInfo);
    ...
    _createClass$A(MediaInfo, [{
      ...
      key: "isBaseInfoReady",
      value: function isBaseInfoReady(mediaInfo) {
        return isObjectFilled$2(mediaInfo);
      }
    }, {
      key: "isVideoReady",
      value: function isVideoReady(mediaInfo) {
        ...
        return isObjectFilled$2(mediaInfo.video);
      }
    }, {
      key: "isAudioReady",
      value: function isAudioReady(mediaInfo) {
  ...
  var DIRECT_EMIT_FLAG$2 = '__TO__';

  var Context$2 = function () {
    function Context() {
      var allowedEvents = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      _classCallCheck$B(this, Context);
      ...
      this.mediaInfo = new MediaInfo$2();
      this._instanceMap = {}; // 所有的解码流程实例
      this._clsMap = {}; // 构造函数的map
      this._inited = false;
      this.allowedEvents = allowedEvents;
    ...
    _createClass$B(Context, [{
      ...
      value: function registry(tag, cls) {
        ...
        var self = this;
        var enhanced = function (_cls) {
          _inherits$4(enhanced, _cls);

          function enhanced(a, b, c) {
            _classCallCheck$B(this, enhanced);

            var _this = _possibleConstructorReturn$4(this, (enhanced.__proto__ || Object.getPrototypeOf(enhanced)).call(this, a, b, c));
          ...
          _createClass$B(enhanced, [{
            ...
            value: function on(messageName, callback) {
              ...
              emitter.on('' + messageName + DIRECT_EMIT_FLAG$2 + tag, callback); // 建立定向通信监听
              return emitter.on(messageName, callback);
            }
            ...
            value: function once(messageName, callback) {
              ...
              emitter.once('' + messageName + DIRECT_EMIT_FLAG$2 + tag, callback);
              return emitter.once(messageName, callback);
            }
          }, {
            key: 'emit',
            ...
            value: function emitTo(tag, messageName) {
              ...
              return emitter.emit.apply(emitter, ['' + messageName + DIRECT_EMIT_FLAG$2 + tag].concat(args));
            }
          }, {
            key: 'off',
            value: function off(messageName, callback) {
              ...
              for (var messageName in this.listeners) {
                if (hasOwn(messageName)) {
                  ...
                  for (var i = 0; i < callbacks.length; i++) {
                    var callback = callbacks[i];
                    emitter.off(messageName, callback);
                    emitter.off('' + messageName + DIRECT_EMIT_FLAG$2 + tag, callback);
                  }
                }
              }
              ...
              for (var _messageName in this.onceListeners) {
                if (hasOwn(_messageName)) {
                  ...
                  for (var _i = 0; _i < _callbacks.length; _i++) {
                    var _callback = _callbacks[_i];
                    emitter.off(_messageName, _callback);
                    emitter.off('' + _messageName + DIRECT_EMIT_FLAG$2 + tag, _callback);
                  }
                }
              }
            }
            ...
            value: function destroy() {
              ...
              // step2 release from context
              delete self._instanceMap[tag];
              if (_get$3(enhanced.prototype.__proto__ || Object.getPrototypeOf(enhanced.prototype), 'destroy', this)) {
                return _get$3(enhanced.prototype.__proto__ || Object.getPrototypeOf(enhanced.prototype), 'destroy', this).call(this);
              }
            }
          }]);
      ...
      key: 'seek',
      value: function seek(time) {
        this._emitter.emit(EVENTS$1.PLAYER_EVENTS.SEEK, time);
      }
  ...
  var _typeof$6 = typeof Symbol === "function" && _typeof2$1(Symbol.iterator) === "symbol" ? function (obj) {
  ...
  var LOADER_EVENTS$4 = EVENTS$1.LOADER_EVENTS;
  var READ_STREAM$1 = 0;
  var READ_TEXT$1 = 1;
  var READ_JSON$1 = 2;
  var READ_BUFFER$1 = 3;

  var FetchLoader$1 = function () {
    function FetchLoader(configs) {
    ...
    _createClass$C(FetchLoader, [{
      key: 'init',
      value: function init() {
        this.on(LOADER_EVENTS$4.LADER_START, this.load.bind(this));
      }
    }, {
      key: 'load',
      value: function load(url, opts) {
        ...
        return fetch(this.url, params).then(function (response) {
          ...
          _this2.loading = false;
          _this2.emit(LOADER_EVENTS$4.LOADER_ERROR, _this2.TAG, new Error(response.status + ' (' + response.statusText + ')'));
        }).catch(function (error) {
          _this2.loading = false;
          _this2.emit(LOADER_EVENTS$4.LOADER_ERROR, _this2.TAG, error);
          throw error;
        });
      }
    }, {
            ...
            case READ_JSON$1:
              response.json().then(function (data) {
                ...
                if (!_this._canceled && !_this._destroyed) {
                  if (buffer) {
                    buffer.push(data);
                    _this.emit(LOADER_EVENTS$4.LOADER_COMPLETE, buffer);
                  } else {
                    _this.emit(LOADER_EVENTS$4.LOADER_COMPLETE, data);
                  }
                }
              });
              break;
      ...
      value: function _onReader(reader, taskno) {
        ...
        this._reader && this._reader.read().then(function (val) {
          ...
          if (val.done) {
            ...
            _this3.status = 0;
            Promise.resolve().then(function () {
              _this3.emit(LOADER_EVENTS$4.LOADER_COMPLETE, buffer);
            });
            return;
          }
          ...
          buffer.push(val.value);
          Promise.resolve().then(function () {
            _this3.emit(LOADER_EVENTS$4.LOADER_DATALOADED, buffer);
          });
          return _this3._onReader(reader, taskno);
        }).catch(function (error) {
          _this3.loading = false;
          _this3.emit(LOADER_EVENTS$4.LOADER_ERROR, _this3.TAG, error);
          throw error;
        });
      }
    }, {
      ...
      value: function getParams(opts) {
        ...
        var params = {
          ...
          // add custmor headers
          // 添加自定义头
        };if (_typeof$6(this.configs.headers) === 'object') {
          var configHeaders = this.configs.headers;
          for (var key in configHeaders) {
            if (configHeaders.hasOwnProperty(key)) {
              headers.append(key, configHeaders[key]);
        ...
        if (_typeof$6(options.headers) === 'object') {
          var optHeaders = options.headers;
          for (var _key in optHeaders) {
            if (optHeaders.hasOwnProperty(_key)) {
              headers.append(_key, optHeaders[_key]);
  ...
  var AudioTrackMeta$1 = function () {
    function AudioTrackMeta(meta) {
      _classCallCheck$D(this, AudioTrackMeta);
  ...
  var VideoTrackMeta$1 = function () {
    function VideoTrackMeta(meta) {
      _classCallCheck$D(this, VideoTrackMeta);
  ...
  var AudioTrack$1 = function (_Track) {
    _inherits$5(AudioTrack, _Track);
    ...
    function AudioTrack() {
      ...
      var _this = _possibleConstructorReturn$5(this, (AudioTrack.__proto__ || Object.getPrototypeOf(AudioTrack)).call(this));
  ...
  var VideoTrack$1 = function (_Track2) {
    _inherits$5(VideoTrack, _Track2);
    ...
    function VideoTrack() {
      ...
      var _this2 = _possibleConstructorReturn$5(this, (VideoTrack.__proto__ || Object.getPrototypeOf(VideoTrack)).call(this));
  ...
  var BROWSER_EVENTS$3 = EVENTS$1.BROWSER_EVENTS;
  var hidden$1 = void 0;
  var visibilityChange$1 = void 0;
  ...
  if (typeof document.hidden !== 'undefined') {
    ...
    hidden$1 = 'msHidden';
    visibilityChange$1 = 'msvisibilitychange';
  } else if (typeof document.webkitHidden !== 'undefined') {
    hidden$1 = 'webkitHidden';
    visibilityChange$1 = 'webkitvisibilitychange';
  }

  var PageVisibility$1 = function () {
    function PageVisibility() {
    ...
    _createClass$F(PageVisibility, [{
      key: 'init',
      value: function init() {
        document.addEventListener(visibilityChange$1, this.handleVisibilityChange, false);
      }
    }, {
      key: 'handleVisibilityChange',
      value: function handleVisibilityChange() {
        this.emit(BROWSER_EVENTS$3.VISIBILITY_CHANGE, document[hidden$1]);
      }
    }, {
      key: 'destroy',
      value: function destroy() {
        document.removeEventListener(visibilityChange$1, this.handleVisibilityChange);
      }
    }]);
  ...
  var AMFParser$1 = function () {
    ...
    _createClass$H(AMFParser, [{
      ...
      value: function parseString(buffer) {
        var dv = new DataView(buffer, this.readOffset);
        var strLen = dv.getUint16(0, !isLe$1);
        var str = '';
        if (strLen > 0) {
      ...
      value: function parseDate(buffer, size) {
        var dv = new DataView(buffer, this.readOffset, size);
        var ts = dv.getFloat64(0, !isLe$1);
        var timeOffset = dv.getInt16(8, !isLe$1);
        ts += timeOffset * 60 * 1000;
      ...
      value: function parseLongString(buffer) {
        var dv = new DataView(buffer, this.readOffset);
        var strLen = dv.getUint32(0, !isLe$1);
        var str = '';
        if (strLen > 0) {
          str = UTF8$1.decode(new Uint8Array(buffer, this.readOffset + 2, strLen));
        } else {
      ...
      value: function parseValue(data, size) {
        ...
        var NUMBER = DATA_TYPES$1.NUMBER,
            BOOLEAN = DATA_TYPES$1.BOOLEAN,
            STRING = DATA_TYPES$1.STRING,
            OBJECT = DATA_TYPES$1.OBJECT,
            MIX_ARRAY = DATA_TYPES$1.MIX_ARRAY,
            OBJECT_END = DATA_TYPES$1.OBJECT_END,
            STRICT_ARRAY = DATA_TYPES$1.STRICT_ARRAY,
            DATE = DATA_TYPES$1.DATE,
            LONE_STRING = DATA_TYPES$1.LONE_STRING;
        ...
        switch (type) {
          case NUMBER:
            {
              value = dataView.getFloat64(1, !isLe$1);
              this.readOffset += 8;
              offset += 8;
              break;
            }
          ...
          case OBJECT:
            {
              value = {};
              var objEndSize = 0;
              if (dataView.getUint32(size - 4, !isLe$1) & 0x00FFFFFF) {
                objEndSize = 3;
              }
              // this.readOffset += offset - 1;
              while (offset < size - 4) {
              ...
              if (offset <= size - 3) {
                var mark = dataView.getUint32(offset - 1, !isLe$1) & 0x00FFFFFF;
                if (mark === 9) {
                  this.readOffset += 3;
                  offset += 3;
                }
          ...
          case MIX_ARRAY:
            {
              ...
              this.readOffset += 4;
              var _objEndSize = 0;
              if ((dataView.getUint32(size - 4, !isLe$1) & 0x00FFFFFF) === 9) {
                _objEndSize = 3;
              }
              ...
              if (offset <= size - 3) {
                var marker = dataView.getUint32(offset - 1, !isLe$1) & 0x00FFFFFF;
                if (marker === 9) {
                  offset += 3;
                  this.readOffset += 3;
                }
          ...
          case STRICT_ARRAY:
            {
              value = [];
              var arrLength = dataView.getUint32(1, !isLe$1);
              offset += 4;
              this.readOffset += 4;
              for (var i = 0; i < arrLength; i++) {
                var script = this.parseValue(buffer, size - offset);
  ...
  var DEMUX_EVENTS$4 = EVENTS$1.DEMUX_EVENTS;
  ...
  var FlvDemuxer$1 = function () {
    ...
    _createClass$J(FlvDemuxer, [{
      key: 'init',
      value: function init() {
        this.on(DEMUX_EVENTS$4.DEMUX_START, this.doParseFlv.bind(this));
      }
      ...
      value: function doParseFlv() {
        if (!this._firstFragmentLoaded) {
          ...
          this.emit(DEMUX_EVENTS$4.DEMUX_COMPLETE);
        }
      }
    }, {
      key: 'parseFlvHeader',
      value: function parseFlvHeader(header) {
        if (!FlvDemuxer.isFlvFile(header)) {
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, new Error('invalid flv file'));
          this.doParseFlv();
        } else {
          this._firstFragmentLoaded = true;
          // const playType = FlvDemuxer.getPlayType(header[4])
      ...
      value: function _parseFlvTagHeader() {
        ...
        if (chunk.tagType !== 8 && chunk.tagType !== 9 && chunk.tagType !== 11 && chunk.tagType !== 18 || this.loaderBuffer.toInt(8, 3) !== 0) {
          ...
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, this.TAG, new Error('tagType ' + chunk.tagType), false);
          return null;
        }
      ...
      value: function _parseScriptData(chunk) {
        ...
        var info = new AMFParser$1().resolve(data, data.length);
        ...
        var validate = this._datasizeValidator(chunk.datasize);
        if (validate) {
          this.emit(DEMUX_EVENTS$4.MEDIA_INFO);
          this._hasScript = true;
        }
      ...
      value: function _parseAACData(chunk) {
        ...
        if (format !== 10) {
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, new Error('invalid audio format: ' + format));
        }
        ...
        if (chunk.data[0] === 0) {
          ...
          if (!this._hasAudioSequence) {
            this.emit(DEMUX_EVENTS$4.METADATA_PARSED, 'audio');
          } else {
            this.emit(DEMUX_EVENTS$4.AUDIO_METADATA_CHANGE);
            // this.emit(DEMUX_EVENTS.METADATA_PARSED, 'audio')
          }
          this._hasAudioSequence = true;
        ...
        if (!validate) {
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, this.TAG, new Error('TAG length error at ' + chunk.datasize), false);
          // this.logger.warn(this.TAG, error.message)
        }
      }
      ...
      value: function _parseHevcData(chunk) {
        ...
        if (codecID === 7 || codecID === 12) {
          ...
          if (chunk.avcPacketType === 0) {
            ...
            if (validate) {
              if (!this._hasVideoSequence) {
                this.emit(DEMUX_EVENTS$4.METADATA_PARSED, 'video');
              } else {
                this.emit(DEMUX_EVENTS$4.VIDEO_METADATA_CHANGE);
                // this.emit(DEMUX_EVENTS.METADATA_PARSED, 'video')
              }
              this._hasVideoSequence = true;
            }
            ...
            if (!this._datasizeValidator(chunk.datasize)) {
              this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, this.TAG, new Error('invalid video tag datasize: ' + chunk.datasize), false);
              return;
            }
            var nals = codecID === 12 ? xgplayerTransmuxerCodecHevc.NalUnitHEVC.getHvccNals(new Stream$1(chunk.data.buffer)) : xgplayerTransmuxerCodecAvc.NalUnit.getAvccNals(new Stream$1(chunk.data.buffer));
            for (var _i = 0; _i < nals.length; _i++) {
              var unit = nals[_i];
              codecID === 12 ? xgplayerTransmuxerCodecHevc.NalUnitHEVC.analyseNal(unit) : xgplayerTransmuxerCodecAvc.NalUnit.analyseNal(unit);
              if (unit.sei) {
                this.emit(DEMUX_EVENTS$4.SEI_PARSED, unit.sei);
              }
            }
            codecID === 12 ? this.tracks.videoTrack.meta.streamType = 0x24 : this.tracks.videoTrack.meta.streamType = 0x1b;
            if (this._videoMetaChange) {
          ...
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, this.TAG, new Error('video codeid is ' + codecID), false);
          chunk.data = this.loaderBuffer.shift(chunk.datasize - 1);
          if (!this._datasizeValidator(chunk.datasize)) {
            this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, this.TAG, new Error('invalid video tag datasize: ' + chunk.datasize), false);
          }
      ...
      value: function _avcSequenceHeaderParser(data) {
        ...
        for (var i = 0; i < numOfSps; i++) {
          ...
          offset += size;
          this.tracks.videoTrack.meta.sps = sps;
          config = xgplayerTransmuxerCodecAvc.SpsParser.parseSPS(sps);
        }
        ...
        Object.assign(meta, xgplayerTransmuxerCodecAvc.SpsParser.toVideoMeta(config));
      ...
      value: function _hevcSequenceHeaderParser(data) {
            ...
            switch (nalUnitType) {
              case 32:
                if (!hasVPS) {
                  hasVPS = true;
                  vps = data.slice(offset + 2, offset + 2 + nalUnitSize);
                  this.tracks.videoTrack.meta.vps = xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(vps);
                }
                break;
              case 33:
                if (!hasSPS) {
                  hasSPS = true;
                  sps = data.slice(offset + 2, offset + 2 + nalUnitSize);
                  this.tracks.videoTrack.meta.sps = xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(sps);
                  meta.codec = 'hev1.1.6.L93.B0';
                  config = xgplayerTransmuxerCodecHevc.SpsParserHEVC.parseSPS(sps);
                }
                break;
              case 34:
                if (!hasPPS) {
                  hasPPS = true;
                  pps = data.slice(offset + 2, offset + 2 + nalUnitSize);
                  this.tracks.videoTrack.meta.pps = xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(pps);
                }
                break;
            }
            offset += 2 + nalUnitSize;
        ...
        Object.assign(meta, xgplayerTransmuxerCodecHevc.SpsParserHEVC.toVideoMeta(config));
      ...
      get: function get() {
        ...
        if (buffer) {
          ...
          this.emit(DEMUX_EVENTS$4.DEMUX_ERROR, new Error('找不到 loaderBuffer 实例'));
        }
      }
    }, {
      key: 'tracks',
  ...
  var _concat2 = _interopRequireDefault(concat$1);
  ...
  var Concat$1 = unwrapExports(lib$1);
  ...
  var Buffer$1 = function () {
    ...
    _createClass$K(Buffer, [{
      ...
      value: function write() {
        ...
        buffer.forEach(function (item) {
          _this.buffer = Concat$1(Uint8Array, _this.buffer, item);
        });
      }
    }], [{
      key: 'writeUint32',
  ...
  var REMUX_EVENTS$5 = EVENTS$1.REMUX_EVENTS;
  var PLAYER_EVENTS$3 = EVENTS$1.PLAYER_EVENTS;
  ...
  var Mp4Remuxer$1 = function () {
    ...
    _createClass$M(Mp4Remuxer, [{
      key: 'init',
      value: function init() {
        this.on(REMUX_EVENTS$5.REMUX_MEDIA, this.remux.bind(this));
        this.on(REMUX_EVENTS$5.REMUX_METADATA, this.onMetaDataReady.bind(this));
        this.on(REMUX_EVENTS$5.DETECT_CHANGE_STREAM, this.resetDtsBase.bind(this));
        this.on(PLAYER_EVENTS$3.SEEK, this.seek.bind(this));
      }
    }, {
      key: 'destroy',
      value: function destroy() {
      ...
      value: function onMetaDataReady(type) {
        ...
        // this.resetDtsBase()
        this.emit(REMUX_EVENTS$5.INIT_SEGMENT, type);
      }
    }, {
      key: 'remuxInitSegment',
      value: function remuxInitSegment(type, meta) {
        var initSegment = new Buffer$1();
        var ftyp = meta.streamType === 0x24 ? Fmp4$1.ftypHEVC() : Fmp4$1.ftyp();
        var moov = Fmp4$1.moov({ type: type, meta: meta });
      ...
      value: function _remuxVideo(videoTrack) {
        ...
        while (samples.length && maxLoop-- > 0) {
          ...
          if (isKeyframe) {
            this.emit(REMUX_EVENTS$5.RANDOM_ACCESS_POINT, pts);
          }
        }
        ...
        this.isFirstVideo = false;
        this.emit(REMUX_EVENTS$5.MEDIA_SEGMENT, 'video');
      ...
      value: function _remuxAudio(track) {
        ...
        this.isFirstAudio = false;
        this.emit(REMUX_EVENTS$5.MEDIA_SEGMENT, 'audio', moofMdat);
  ...
  var PreSource$1 = function () {
    ...
    _createClass$N(PreSource, [{
      ...
      key: 'createSource',
      value: function createSource(name) {
        this.sources[name] = new Source$1();
        return this.sources[name];
      }
    }, {
      key: 'clear',
  ...
  var REMUX_EVENTS$6 = EVENTS$1.REMUX_EVENTS;

  var Compatibility$1 = function () {
    function Compatibility() {
    ...
    _createClass$R(Compatibility, [{
      key: 'init',
      value: function init() {
        this.before(REMUX_EVENTS$6.REMUX_MEDIA, this.doFix.bind(this));
      }
    }, {
      key: 'reset',
      value: function reset() {
      ...
      value: function doFixAudio(first, streamChangeStart) {
        ...
        var samplesLen = audioSamples.length;
        var silentFrame = AAC$1.getSilentFrame(meta.codec, meta.channelCount);
      ...
      value: function fixChangeStreamVideo(changeIdx) {
        ...
        this.emit(REMUX_EVENTS$6.DETECT_CHANGE_STREAM_DISCONTINUE);
  ...
  var REMUX_EVENTS$7 = EVENTS$1.REMUX_EVENTS;
  var DEMUX_EVENTS$5 = EVENTS$1.DEMUX_EVENTS;
  var LOADER_EVENTS$5 = EVENTS$1.LOADER_EVENTS;
  ...
  var FlvController$1 = function () {
    ...
    _createClass$T(FlvController, [{
      ...
      value: function init() {
        ...
        this._context.registry('TRACKS', Track$1);
        ...
        if (!this.mse) {
          this.mse = new MSE$1({ container: this._player.video }, this._context);
          this.mse.init();
        }
      ...
      key: 'initListeners',
      value: function initListeners() {
        this.on(LOADER_EVENTS$5.LOADER_DATALOADED, this._handleLoaderDataLoaded.bind(this));
        this.on(LOADER_EVENTS$5.LOADER_ERROR, this._handleNetworkError.bind(this));

        this.on(DEMUX_EVENTS$5.MEDIA_INFO, this._handleMediaInfo.bind(this));
        this.on(DEMUX_EVENTS$5.METADATA_PARSED, this._handleMetadataParsed.bind(this));
        this.on(DEMUX_EVENTS$5.DEMUX_COMPLETE, this._handleDemuxComplete.bind(this));
        this.on(DEMUX_EVENTS$5.DEMUX_ERROR, this._handleDemuxError.bind(this));
        this.on(DEMUX_EVENTS$5.SEI_PARSED, this._handleSEIParsed.bind(this));

        this.on(REMUX_EVENTS$7.INIT_SEGMENT, this._handleAppendInitSegment.bind(this));
        this.on(REMUX_EVENTS$7.MEDIA_SEGMENT, this._handleMediaSegment.bind(this));
      }
    }, {
      key: '_handleMediaInfo',
      value: function _handleMediaInfo() {
        ...
        if (!this._context.onMetaData) {
          this.emit(DEMUX_EVENTS$5.DEMUX_ERROR, new Error('failed to get mediainfo'));
        }
        var buffer = this._context.getInstance('LOADER_BUFFER');
        var loader = this._context.getInstance('FETCH_LOADER');
        if (this.isSeekable) {
      ...
      key: '_handleLoaderDataLoaded',
      value: function _handleLoaderDataLoaded() {
        this.emitTo('FLV_DEMUXER', DEMUX_EVENTS$5.DEMUX_START);
      }
    }, {
      key: '_handleMetadataParsed',
      value: function _handleMetadataParsed(type) {
        this.emit(REMUX_EVENTS$7.REMUX_METADATA, type);
      }
    }, {
      key: '_handleSEIParsed',
      value: function _handleSEIParsed(sei) {
      ...
      key: '_handleDemuxComplete',
      value: function _handleDemuxComplete() {
        this.emit(REMUX_EVENTS$7.REMUX_MEDIA);
      }
    }, {
      key: '_handleAppendInitSegment',
      value: function _handleAppendInitSegment() {
      ...
      value: function _handleNetworkError(tag, err) {
        this._player.emit('error', new Player.Errors('network', this._player.config.url));
        this._onError(LOADER_EVENTS$5.LOADER_ERROR, tag, err, true);
      }
    }, {
      key: '_handleDemuxError',
      value: function _handleDemuxError(tag, err, fatal) {
        ...
        this._player.emit('error', new Player.Errors('parse', this._player.config.url));
        this._onError(LOADER_EVENTS$5.LOADER_ERROR, tag, err, fatal);
      }
    }, {
      key: '_onError',
      value: function _onError(type, mod, err, fatal) {
      ...
      value: function loadData() {
        ...
        this.emit(LOADER_EVENTS$5.LADER_START, this._player.config.url, {
          headers: {
            method: 'get',
  ...
  var flvAllowedEvents$1 = EVENTS$1.FlvAllowedEvents;
  ...
  var FlvVodPlayer = function (_Player) {
    ...
    _createClass$U(FlvVodPlayer, [{
      ...
      value: function initFlvBackupEvents(flv, ctx) {
        ...
        flv.once(EVENTS$1.REMUX_EVENTS.INIT_SEGMENT, function () {
          var mediaLength = 3;
          flv.on(EVENTS$1.REMUX_EVENTS.MEDIA_SEGMENT, function () {
            mediaLength -= 1;
            if (mediaLength === 0) {
              // ensure switch smoothly
              _this2.flv = flv;
        ...
        flv.once(EVENTS$1.LOADER_EVENTS.LOADER_ERROR, function () {
          ctx.destroy();
        });
      }
    }, {
