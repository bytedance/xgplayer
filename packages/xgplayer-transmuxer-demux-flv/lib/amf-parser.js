...
var _xgplayerUtilsUtf = require('xgplayer-utils-utf8');

var _xgplayerUtilsUtf2 = _interopRequireDefault(_xgplayerUtilsUtf);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var isLe = _xgplayerUtilsSniffer2.default.isLe;
...
var AMFParser = function () {
  ...
  _createClass(AMFParser, [{
    ...
    value: function parseString(buffer) {
      ...
      var str = '';
      if (strLen > 0) {
        str = _xgplayerUtilsUtf2.default.decode(new Uint8Array(buffer, this.readOffset + 2, strLen));
      } else {
        str = '';
      }
      var size = strLen + 2;
