...
var FlvDemuxer = function () {
  ...
  _createClass(FlvDemuxer, [{
    ...
    value: function _parseHevcData(chunk) {
      ...
      if (codecID === 7 || codecID === 12) {
        ...
        if (chunk.avcPacketType === 0) {
          ...
          var nals = codecID === 12 ? _xgplayerTransmuxerCodecHevc.NalUnitHEVC.getHvccNals(new _xgplayerTransmuxerBufferStream2.default(chunk.data.buffer)) : _xgplayerTransmuxerCodecAvc.NalUnit.getAvccNals(new _xgplayerTransmuxerBufferStream2.default(chunk.data.buffer));
    ...
    value: function _hevcSequenceHeaderParser(data) {
          ...
          switch (nalUnitType) {
            case 32:
              if (!hasVPS) {
                ...
                this.tracks.videoTrack.meta.vps = _xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(vps);
              }
              break;
            case 33:
              if (!hasSPS) {
                ...
                this.tracks.videoTrack.meta.sps = _xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(sps);
                meta.codec = 'hev1.1.6.L93.B0';
                config = _xgplayerTransmuxerCodecHevc.SpsParserHEVC.parseSPS(sps);
              }
              break;
            case 34:
              if (!hasPPS) {
                ...
                this.tracks.videoTrack.meta.pps = _xgplayerTransmuxerCodecHevc.SpsParserHEVC._ebsp2rbsp(pps);
              }
              break;
            case 39:
              // PREFIX_SEI
      ...
      Object.assign(meta, _xgplayerTransmuxerCodecHevc.SpsParserHEVC.toVideoMeta(config));
