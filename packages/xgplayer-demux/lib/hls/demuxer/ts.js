  ...
  _createClass(TsDemuxer, [{
    ...
    value: function demux(frag) {
      ...
      while (buffer.length >= 188) {
        ...
        // console.log(buf);
        var tsStream = new _xgplayerUtils.Stream(buf.buffer);
        var ts = {};
    ...
    value: function pushAudioSample(pes, options) {
      ...
      var meta = new _xgplayerUtils.AudioTrackMeta({
      ...
      var sample = new _xgplayerUtils.AudioTrackSample({ dts: dts, pts: pts, data: data, options: options });
      track.samples.push(sample);
    }
  }, {
    key: 'pushVideoSample',
    value: function pushVideoSample(pes, options) {
      var nals = _xgplayerCodec.Nalunit.getNalunits(pes.ES.buffer);
      var track = void 0;
      var meta = new _xgplayerUtils.VideoTrackMeta();
      ...
      var sample = new _xgplayerUtils.VideoTrackSample({
