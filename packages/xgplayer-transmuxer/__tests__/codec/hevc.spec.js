...
describe('HEVC', () => {
  test('parseHEVCDecoderConfigurationRecord', () => {
    const vps = [
      64, 1, 12, 1, 255, 255, 1, 96, 0, 0, 3, 0, 176, 0, 0, 3, 0, 0, 3, 0, 90, 23, 2, 64
    ]
    const sps = [
      66, 1, 1, 1, 96, 0, 0, 3, 0, 176, 0, 0, 3, 0, 0, 3, 0, 90, 160, 4, 66, 0, 240, 88,
      129, 123, 145, 100, 82, 255, 203, 159, 196, 254, 136
    ]
  ...
  test('parseSPS', () => {
    const data = new Uint8Array([
      66, 1, 1, 1, 96, 0, 0, 0, 144, 0, 0, 0, 0, 0, 60, 160, 12, 72, 4, 199, 119, 150, 86,
      105, 36, 202, 255, 240, 14, 208, 14, 182, 128, 128, 0, 0, 0, 128, 0, 0, 7, 132
    ])
