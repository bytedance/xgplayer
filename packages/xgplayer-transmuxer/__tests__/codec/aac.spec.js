...
describe('AAC', () => {
  test('invalid aac data', () => {
    const result = AAC.parseADTS(new Uint8Array([11, 2, 3, 421, 125, 1, 5, 2, 5]))
  ...
  test('parseADTS', () => {
    const frame1 = [
      222, 4, 0, 0, 108, 105, 98, 102, 97, 97, 99, 32, 49, 46, 50, 56, 0, 0, 66, 0, 147,
      32, 4, 50, 0, 71
    ]
  ...
  test('getSilentFrame', () => {
    expect(AAC.getSilentFrame('mp4a.40.2', 1)).toEqual(
