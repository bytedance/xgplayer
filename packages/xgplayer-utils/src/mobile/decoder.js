var getModule = function(par_broadwayOnBroadwayInited, par_broadwayOnPictureDecoded){
  var Module = (function() {
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5482208,
    DYNAMIC_BASE = 5482208,
    DYNAMICTOP_PTR = 239120;
...
var wasmBinaryFile = 'http://localhost:9090/examples/flv/decoder_em.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _broadwayOnBroadwayInited() {
      par_broadwayOnBroadwayInited();
    }
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 239216, 4), 239216);function _gmtime_r(time, tmPtr) {
...
var asmLibraryArg = { "___buildEnvironment": ___buildEnvironment, "___setErrNo": ___setErrNo, "___syscall221": ___syscall221, "___syscall3": ___syscall3, "___syscall5": ___syscall5, "___wasi_fd_close": ___wasi_fd_close, "___wasi_fd_fdstat_get": ___wasi_fd_fdstat_get, "___wasi_fd_seek": ___wasi_fd_seek, "___wasi_fd_write": ___wasi_fd_write, "__memory_base": 1024, "__table_base": 0, "_abort": _abort, "_broadwayOnBroadwayInited": _broadwayOnBroadwayInited, "_broadwayOnPictureDecoded": _broadwayOnPictureDecoded, "_clock": _clock, "_emscripten_get_heap_size": _emscripten_get_heap_size, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_resize_heap": _emscripten_resize_heap, "_exit": _exit, "_fabs": _fabs, "_fd_close": _fd_close, "_fd_fdstat_get": _fd_fdstat_get, "_fd_seek": _fd_seek, "_fd_write": _fd_write, "_getenv": _getenv, "_gettimeofday": _gettimeofday, "_gmtime_r": _gmtime_r, "_llvm_exp2_f32": _llvm_exp2_f32, "_llvm_exp2_f64": _llvm_exp2_f64, "_llvm_trunc_f64": _llvm_trunc_f64, "_localtime_r": _localtime_r, "_mktime": _mktime, "_tzset": _tzset, "abort": abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "demangle": demangle, "demangleAll": demangleAll, "getTempRet0": getTempRet0, "jsStackTrace": jsStackTrace, "memory": wasmMemory, "setTempRet0": setTempRet0, "stackTrace": stackTrace, "table": wasmTable, "tempDoublePtr": tempDoublePtr };
...
// {{MODULE_ADDITIONS}}
  ...
  resultModule._broadwayOnBroadwayInit = par_broadwayOnBroadwayInited;
...
var Decoder = function(parOptions){
  ...
  var Module = getModule.apply(fakeWindow, [function () {
    _this.decoderReady = true;
    _this.onDecoderReady && _this.onDecoderReady();
  }, onPicFun]);

  Module.onRuntimeInitialized = function() { 
    Module._broadwayInit();
    _this.streamBuffer = toU8Array(Module._broadwayCreateStream(MAX_STREAM_BUFFER_LENGTH), MAX_STREAM_BUFFER_LENGTH);
  }
...
module.exports = function(self) {
  ...
  self.addEventListener('message', function(e) {
    ...
    if(!data.msg) {
      ...
      switch(data.msg) {
        case 'init':
          decoder = new Decoder({rgb: true});
          decoder.onDecoderReady = function() {
            self.postMessage({
              msg: 'DECODER_READY'
            })
          }

          decoder.onPictureDecoded = function(data, width, height, info) {
            self.postMessage({
              msg: 'DECODED',
              data,
              width,
