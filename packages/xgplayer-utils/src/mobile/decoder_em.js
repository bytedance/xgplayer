...
var xgprops = {
  isInited: false,
  onWasmCompiled: undefined,
  onFrameDecoded: undefined
}
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5277424,
    DYNAMIC_BASE = 5277424,
    DYNAMICTOP_PTR = 34336;
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    Module['asm'] = exports;
    if(xgprops.onWasmCompiled) {
      xgprops.onWasmCompiled(Module);
    }
...
var asmLibraryArg = { "___assert_fail": ___assert_fail, "___buildEnvironment": ___buildEnvironment, "___cxa_uncaught_exceptions": ___cxa_uncaught_exceptions, "___gxx_personality_v0": ___gxx_personality_v0, "___syscall140": ___syscall140, "___syscall6": ___syscall6, "___wasi_fd_write": ___wasi_fd_write, "__emscripten_traverse_stack": __emscripten_traverse_stack, "__formatString": __formatString, "__memory_base": 1024, "__reallyNegative": __reallyNegative, "__table_base": 0, "_emscripten_asm_const_iiiiiiii": _emscripten_asm_const_iiiiiiii, "_emscripten_get_callstack_js": _emscripten_get_callstack_js, "_emscripten_get_heap_size": _emscripten_get_heap_size, "_emscripten_log": _emscripten_log, "_emscripten_log_js": _emscripten_log_js, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_resize_heap": _emscripten_resize_heap, "_fd_write": _fd_write, "_gettimeofday": _gettimeofday, "abort": abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "demangle": demangle, "demangleAll": demangleAll, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "getTempRet0": getTempRet0, "jsStackTrace": jsStackTrace, "memory": wasmMemory, "setTempRet0": setTempRet0, "stackTrace": stackTrace, "table": wasmTable, "tempDoublePtr": tempDoublePtr };
...
var _close_decoder = Module["_close_decoder"] = function() {
  return Module["asm"]["_close_decoder"].apply(null, arguments)
};

var _decode_h264buffer = Module["_decode_h264buffer"] = function() {
  return Module["asm"]["_decode_h264buffer"].apply(null, arguments)
};

var _decode_nal = Module["_decode_nal"] = function() {
  return Module["asm"]["_decode_nal"].apply(null, arguments)
};
...
var _open_decoder = Module["_open_decoder"] = function() {
  return Module["asm"]["_open_decoder"].apply(null, arguments)
};
...
if(Module['asm'] && Object.keys(Module['asm']).length > 0){
...
function frame_callback(a,b,c,width,height,stride1,stride2)
{
    ...
    xgprops.onFrameDecoded(data);
}

module.exports = function (self){
  xgprops.onWasmCompiled = function(Module) {
    decoder = open_decoder();
    self.postMessage({
      msg: 'WASM_LOADED'
    });
  ...
  self.addEventListener('message', function(e) {
    ...
    switch(message.type) {
      ...
      case 'decode':
        decode(message.data);
      case 'inited':
        self.postMessage({msg:'INITED_ECHO',
          data: (Module['asm'] && Object.keys(Module['asm']).length > 0) ? true : false
        })
      default:
        break;
    }
