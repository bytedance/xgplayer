...
import HevcWorker from 'web-worker:./hevc-worker.js'
import HevcThreadWorker from 'web-worker:./hevc-worker-thread.js'
import AvcWorker from 'web-worker:./worker.js'
...
export default class DecodeWorkerManager extends EventEmitter {
  ...
  addDecodeWorker () {
    ...
    const { _timeRange, _decodeEstimate, gopLength } = this._parent
