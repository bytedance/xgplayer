(function (factory) {
  ...
  var YUVCanvas = function () {
    function YUVCanvas(configs) {
      _classCallCheck$7(this, YUVCanvas);
  ...
  var SourceBuffer = function () {
    function SourceBuffer(config) {
      _classCallCheck$8(this, SourceBuffer);
  ...
  var TimeRanges = function () {
    function TimeRanges(ranges) {
      _classCallCheck$9(this, TimeRanges);

      this.ranges = ranges || [];
    }

    _createClass$9(TimeRanges, [{
      key: "start",
  ...
  var AVReconciler = function () {
    function AVReconciler(props) {
      _classCallCheck$c(this, AVReconciler);
