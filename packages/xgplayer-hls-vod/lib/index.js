...
var Events = _xgplayer2.default.Events,
    BasePlugin = _xgplayer2.default.BasePlugin;
...
var HlsVodPlayer = function (_BasePlugin) {
  ...
  _createClass(HlsVodPlayer, [{
    ...
    value: function beforePlayerInit() {
      ...
      this.hls = this._context.registry('HLS_VOD_CONTROLLER', _hlsVod2.default)({ player: this.player, preloadTime: this.player.config.preloadTime });
      this._context.init();
    ...
    value: function __initEvents() {
      ...
      this.hls.once(HLS_EVENTS.RETRY_TIME_EXCEEDED, function () {
        _this5.emit('error', new _xgplayer2.default.Errors('network', _this5.config.url));
      });
