...
var FlvPlayer = function (_BasePlugin) {
  ...
  _createClass(FlvPlayer, [{
    ...
    value: function initFlv() {
      var flv = this.context.registry('FLV_CONTROLLER', _flvLive2.default)(this.player);
    ...
    value: function play() {
      ...
      if (this.played && this.player.played.length) {
        ...
        return this._destroy().then(function () {
          _this6.context = new _xgplayerTransmuxerContext2.default(flvAllowedEvents);
    ...
    value: function switchURL(url) {
      ...
      var flv = context.registry('FLV_CONTROLLER', _flvLive2.default)(this.player, this.mse);
      context.init();
