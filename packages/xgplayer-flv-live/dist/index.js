(function (global, factory) {
  ...
  var Logger = function () {
    function Logger() {
      _classCallCheck$s(this, Logger);
    }

    _createClass$s(Logger, [{
      key: 'warn',
      value: function warn() {}
    }]);
  ...
  var FlvController = function () {
    function FlvController(player, mse) {
      _classCallCheck$s(this, FlvController);
  ...
  var FlvPlayer = function (_Player) {
    ...
    function FlvPlayer(config) {
      _classCallCheck$t(this, FlvPlayer);
