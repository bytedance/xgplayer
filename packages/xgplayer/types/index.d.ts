...
declare module "error" {
    ...
    class Errors {
        constructor(type: any, currentTime: any, duration: any, networkState: any, readyState: any, src: any, currentSrc: any, ended: any, errd: {
            line: string;
            handle: string;
            msg: string;
            version: string;
        }, errorCode: any, mediaError: any, ...args: any[]);
    }
}
