  ...
  _createClass(Plugin, [{
    ...
    value: function bind(querySelector, eventType, callback) {
      ...
      if (arguments.length < 3 && typeof eventType === 'function') {
        ...
        _delegateEvents2.default.bind(this.el, querySelector, eventType, callback, false);
      }
    }
  }, {
    key: 'unbind',
    value: function unbind(querySelector, eventType, callback) {
      ...
      if (arguments.length < 3 && typeof eventType === 'function') {
        ...
        _delegateEvents2.default.ubind(this.el, querySelector, eventType, callback, false);
      }
    }
  }, {
    key: 'setStyle',
