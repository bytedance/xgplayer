...
var delegate = _interopRequireWildcard(_delegateEvents);
...
var Plugin = function (_BasePlugin) {
  ...
  _createClass(Plugin, [{
          ...
          try {
            for (var _iterator = Object.keys(children)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (typeof _plugin === 'function') {
                ...
                config = _plugin.options ? _basePlugin2.default.Util.deepCopy(this.config[name] || {}, _plugin.options) : this.config[name] || {};
    ...
    value: function registerPlugin(plugin) {
      ...
      var _c = _pluginsManager2.default.register(this.player, plugin, options);
    ...
    value: function getPlugin(name) {
      return _pluginsManager2.default.findPlugin(this.player, name);
    }
  }, {
    key: 'find',
    ...
    value: function _destroy() {
      this.offAll();
      if (_basePlugin2.default.Util.checkIsFunction(this.destroy)) {
        this.destroy();
      }
      if (this.root) {
