...
class Player extends Proxy {
  ...
  _startInit (url) {
    ...
    if (this.config.autoplay) {
      console.log('>>>this.config.autoplay', this.config.autoplay)
      this.play()
      this.removeClass(STATE_CLASS.ENTER)
  ...
  play () {
    console.log('play>>>this.hasStart', this.hasStart)
    // if (!this.hasStart) {
    ...
    // console.log('playPromise', playPromise.then, playPromise.catch)
    if (playPromise !== undefined && playPromise) {
      console.log('>>>playPromise start')
      playPromise.catch((e) => {
        // console.log('AUTOPLAY_PREVENTED', e)
        // 避免AUTOPLAY_PREVENTED先于playing和play触发
        console.log('>>>playPromise.catch', e)
        setTimeout(() => {
      ...
      console.log('play:paused', this.paused)
      setTimeout(() => {
        console.log('setTimeout:paused', this.paused, this.currentTime)
