...
let i18n = function () {
  ...
  lang['jp'] = {
    ...
    MEDIA_ERR_SRC_NOT_SUPPORTED: 'Audio/video is not supported',
    REPLAY: 'リプレイ',
    ERROR: 'ネットワークはオフラインです',
    PLAY_TIPS: '遊ぶ',
    PAUSE_TIPS: '一時停止',
    PLAYNEXT_TIPS: '次のエピソード',
    DOWNLOAD_TIPS: 'ダウンロード',
    ROTATE_TIPS: '回転させる',
    FULLSCREEN_TIPS: "全画面を入力",
    EXITFULLSCREEN_TIPS: '全画面を終了',
    CSSFULLSCREEN_TIPS: 'フルスクリーンスタイルを入力',
    EXITCSSFULLSCREEN_TIPS: '出口スタイル全画面',
    TEXTTRACK: '字幕',
    PIP: '絵の中の絵',
    SCREENSHOT: 'Screenshot'
  }
