...
var s_progress = function s_progress() {
  ...
  container.addEventListener('mouseenter', function (e) {
    ...
    var isRotate = isRotateFullscreen(player);
    var containerLeft = isRotate ? container.getBoundingClientRect().left : container.getBoundingClientRect().top;
    var containerWidth = isRotate ? container.getBoundingClientRect().width : container.getBoundingClientRect().height;
  ...
  var onTimeupdate = function onTimeupdate() {
    ...
    if (player.videoConfig.mediaType !== 'audio' || !player.isProgressMoving || !player.dash) {
      var precent = player.currentTime * 100 / player.duration;
      var prevWidth = Number.parseFloat(progress.style.width || '0');
