...
var Fmp4 = function () {
  ...
  _createClass(Fmp4, null, [{
    ...
    value: function initBox(size, name) {
      var buffer = new _xgplayerUtils.Buffer();
    ...
    value: function mvex(duration) {
      ...
      var buffer = new _xgplayerUtils.Buffer();
      var mehd = _xgplayerUtils.Buffer.writeUint32(duration);
    ...
    key: 'mfhd',
    value: function mfhd() {
      var content = _xgplayerUtils.Buffer.writeUint32(Fmp4.sequence);
      Fmp4.sequence += 1;
    ...
    value: function tfhd(id) {
      var content = _xgplayerUtils.Buffer.writeUint32(id);
    ...
    value: function trun(data, sdtpLength) {
      ...
      // let ceil = id === 1 ? 16 : 12;
      var buffer = new _xgplayerUtils.Buffer();
      var sampleCount = _xgplayerUtils.Buffer.writeUint32(data.samples.length);
      // mdat-header 8
      // moof-header 8
      // mfhd 16
      // traf-header 8
      ...
      // data-offset 4
      // samples.length
      var offset = _xgplayerUtils.Buffer.writeUint32(8 + 8 + 16 + 8 + 16 + 16 + 12 + 4 + 4 + 16 * data.samples.length + sdtpLength);
