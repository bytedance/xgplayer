...
var PLAYER_EVENTS = _xgplayerUtils.EVENTS.PLAYER_EVENTS;
...
var Mp4Remuxer = function () {
  function Mp4Remuxer() {
    ...
    var browser = _xgplayerUtils.sniffer.browser;
  ...
  _createClass(Mp4Remuxer, [{
    ...
    value: function remuxInitSegment(type, meta) {
      var initSegment = new _xgplayerUtils.Buffer();
    ...
    value: function _remuxVideo(videoTrack) {
      ...
      var moofMdat = new _xgplayerUtils.Buffer();
