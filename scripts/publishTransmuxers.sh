...
#cd ${SRC_DIR}/packages/xgplayer-raw264 && npm publish --tag=beta --registry https://registry.npmjs.org
...
cd ${SRC_DIR}/packages/xgplayer-flv && npm publish --tag=beta --registry https://registry.npmjs.org
